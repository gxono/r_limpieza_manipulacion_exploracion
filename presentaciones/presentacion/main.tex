...
\end{lstlisting}
	...
	\begin{frame}{R vs. Excel}
		...
		En R, el proceso completo desde la importación de datos (Excel, CSV) hasta el resultado final queda registrado.
	\end{frame}
	...
	\begin{frame}[fragile]{¿Qué NO es este curso?}
		\begin{itemize}
			\item No es un curso de programación general (no van a aprender a hacer apps o sitios web).
			\item No es un curso de estadística teórica.
		\end{itemize}
	\end{frame}
